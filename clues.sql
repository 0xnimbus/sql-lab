...
SELECT * FROM country WHERE code2 = 'SM';
-- SHE IS IN SAN MORINO 
SELECT * FROM city WHERE countrycode = 'SMR'
--Cities are Serravalle and San Marino
...
--CAPITAL OF BRAZIL ID is 211

SELECT * FROM city WHERE id = '211' 
--CAPITAL NAME IS Bras∩┐╜lia
